...
impl ProxyConfig {
    ...
    pub fn from_env() -> Result<Self> {
        ...
        config.javelin.api_key = env::var("LLM_API_KEY")
            .or_else(|_| env::var("OPENAI_API_KEY"))
            .or_else(|_| env::var("JAVELIN_API_KEY"))
            .map_err(|_| {
                ramparts_common::anyhow::anyhow!(
                    "API key required. Set LLM_API_KEY, OPENAI_API_KEY, or JAVELIN_API_KEY environment variable."
                )
            })?;
